        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-2">
              <a href="https://www.facebook.com/share/187Xc9ePcf/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#172A45] flex items-center justify-center text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#0A192F] transition-all duration-300">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/chaudharytravelsofficial/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#172A45] flex items-center justify-center text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#0A192F] transition-all duration-300">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3 text-[#8892B0]">
                  ...
                  <a href="tel:9540726566" className="hover:text-white transition-colors">+91-9540726566</a>
                </div>
                <div className="flex items-center gap-3 text-[#8892B0]">
                  <Phone className="w-5 h-5 text-[#D4AF37] shrink-0" />
                  <a href="tel:9773990526" className="hover:text-white transition-colors">+91-9773990526</a>
                </div>
              </div>
              <div className="flex items-center gap-3 text-[#8892B0]">
